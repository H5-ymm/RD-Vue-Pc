    ...
    <el-main class="home-main-content">
      <div class="home-main-box">
        ...
        <el-row class="home-img-box" v-if="imgList.length&&imgList.length==2">
          ...
          <el-col :span="8">
            <div class="bg-purple-right grid-content">
              <div class="bg-purple-img-right bg-purple-img-right2">
                <img :src="getImgUrl(imgList[1].image)" alt="">
              </div>
            </div>
          </el-col>
        </el-row>
        <el-row class="home-img-box" v-if="imgList.length&&imgList.length==3">
          ...
          <el-col :span="8">
            <div class="bg-purple-right grid-content">
              <div class="bg-purple-img-right">
                <img :src="getImgUrl(imgList[1].image)" alt="">
              </div>
              <div class="bg-purple-img-right bg-purple-img-right1">
                <img :src="getImgUrl(imgList[2].image)" alt="">
              </div>
            </div>
          </el-col>
        </el-row>
                ...
                <div slot="header" class="clearfix">
                  ...
                  >
                    <el-col :span="14">
                      ...
                      >{{getmoneyType(item.money_type)}}薪: {{item.money_min}} ~ {{item.money_max}}元</div>
                      <div
                        class="bg-purple"
                        v-else
                      >{{getmoneyType(item.money_type)}}薪: {{item.money}}元</div>
                    </el-col>
                    <el-col :span="10">
                  ...
                  <el-row type="flex" justify="space-between" class="home-list-clearfix">
                    <el-col :span="14">
                      <div
                        class="bg-purple"
                      >返利: {{item.reward_money}}/人/{{getRewardType(item.reward_type)}}</div>
                    </el-col>
                    <el-col :span="10">
        ...
        <section class="home-main-section">
          <div class="home-main-title x-flex-between">
            <p>
              <img src="../assets/img/icon2.png">资讯
            </p>
            <p class="x-flex-end">
