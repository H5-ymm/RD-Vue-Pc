    ...
    <div class="table-list">
      ...
      >
        ...
        <el-collapse-transition>
          <div v-show="show" class="senior-search-box x-flex-between">
            <div>
...
import { moneyTypeList, rewardTypeList, payTypeList, weekList, recommendStatusList, timeStatusList } from '@/base/base'
