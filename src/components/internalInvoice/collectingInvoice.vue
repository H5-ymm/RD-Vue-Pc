    ...
    <div class="table-list">
      ...
      <div class="member-table">
        ...
        <el-table border="" :data="tableData" ref="multipleTable" style="width: 100%">
          <el-table-column label="企业名称" align="center" width="150" prop="company_name"></el-table-column>
          ...
          <el-table-column label="招聘人数" align="center" width="110" prop="number"></el-table-column>
          <el-table-column label="上架状态" align="center" width="110">
            <template slot-scope="props">
              <span
                class="status"
                :class="`status${props.row.is_up?props.row.is_up:3}`"
          ...
          <el-table-column label="操作" align="center" min-width="150">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                v-if="scope.row.is_up==1 && userPosition==2&&!scope.row.tolist"
                type="text"
                size="small"
              >领取</el-button>
              <span
