      ...
      <el-table-column label="职位名称"  align="center" width="150">
        ...
        <el-table-column label="操作" align="center" width="150">
          <template slot-scope="scope">
            ...
            <el-button @click="$router.push('/entryDetailTable')" type="text" size="small">入职名单
              <span class="resume-number">(+150)</span></el-button>
            </el-button>
            <el-button @click="handleEdit(scope.row)" type="text" size="small">面试结束</el-button>
            <el-button @click="handleDel(scope.row)" type="text" size="small">查看简历</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
