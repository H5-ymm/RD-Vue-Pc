  ...
  <div class="tables-box billingManagement">
    <div class="table-list">
      <el-form :inline="true" label-width="100px" label-position="right" :model="formMember" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button type="primary" @click="onSubmit" class="select-btn">
            查询
          </el-button>
      ...
      <el-table-column label="职位名称"  align="center" width="150">
        ...
        <el-table-column label="操作" align="center" width="150">
          <template slot-scope="scope">
            ...
            <el-button @click="handleDel(scope.row)" type="text" size="small">入职时间</el-button>
            <el-button @click="$router.push('/auditionResult')" type="text" size="small">面试结果 <span class="resume-number">(+150)</span></el-button></el-button>
            <el-button @click="$router.push('/viewResume')" type="text" size="small">查看简历</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
