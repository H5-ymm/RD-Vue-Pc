<template>
  <div class="salary-rebate">
    ...
    <el-form-item label="返利模式" class="reward_type" required>
      <div class="x-flex-start width700">
        ...
        <div v-if="orderTakingForm.reward_type">
          <el-input placeholder="请输入金额" v-if="orderTakingForm.reward_type==1" 
           class="width160 text-input" v-model="orderTakingForm.reward_money">
            <template slot="append">
    ...
    <el-form-item class="reward_type">
      <div class="x-flex-start width500" v-if="orderTakingForm.reward_type==1&&orderTakingForm.reward_money_type==3">
        <el-input placeholder="请输入" class="width160 text-input" v-model="orderTakingForm.money">
          <template slot="prepend">
        ...
        <el-select v-model="orderTakingForm.reward_money_type"  @blur="blurInput" @change="changePayType"  class="width160" placeholder="结算类型">
          ...
          ></el-option>
           <div
            ...
            :value="2"
          >
          <el-input placeholder="请输入" class="text-input" v-model="orderTakingForm.settlement_time" @change="changeInput">
              <template slot="prepend">
      ...
      <div class="x-flex-start width700" v-if="orderTakingForm.reward_type!=1&&orderTakingForm.reward_type!=4">
        <el-input placeholder="请输入" class="width160 text-input" v-model="orderTakingForm.money" v-if="orderTakingForm.reward_money_type">
          <template slot="append">
            <span class="moneyType">元/人/{{rewardType}}</span>
          </template>
        </el-input>
        <el-select v-model="orderTakingForm.reward_pay_type" class="width160" placeholder="结算类型" v-if="orderTakingForm.reward_money_type">
          <el-option
            :label="`次${rewardType}结算`"
            :value="1"
          ></el-option>
           <el-option
            :label="`本${rewardType}结算`"
            :value="2"
          ></el-option>
        </el-select>
         <el-select v-model="orderTakingForm.reward_money_type_value"
         v-if="orderTakingForm.reward_pay_type&&orderTakingForm.reward_money_type==2" 
         class="width160" placeholder="请选择">
          <el-option
    ...
    <el-form-item class="reward_type" v-if="(orderTakingForm.reward_type==2||orderTakingForm.reward_type==3)&&orderTakingForm.reward_money_type">
        <div class="x-flex-start-justify width500">
          <el-input placeholder="请输入" @focus="focusInput" class="width160 text-input" v-model="orderTakingForm.money">
            <template slot="prepend">
          ...
          <el-input placeholder="请输入" class="width160 text-input" @focus="focusInput" v-model="orderTakingForm.money">
            <template slot="prepend">
              <span class="moneyType">需入职满</span>
            </template>
            <template slot="append">
